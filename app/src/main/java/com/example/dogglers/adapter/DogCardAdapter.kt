...
class DogCardAdapter(
    ...
    class DogCardViewHolder(private val view: View): RecyclerView.ViewHolder(view) {
        ...
        val dogHobbies: TextView = view.findViewById(R.id.dog_hobby)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val view: View = when(layout) {
            Layout.VERTICAL, Layout.HORIZONTAL -> LayoutInflater.from(parent.context)
                .inflate(R.layout.vertical_horizontal_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        //resources?.g    getString(R.string.dog_hobbies, item.hobbies)
